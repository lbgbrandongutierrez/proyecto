    ...
    <div class="container">
            ...
            <div class="col-md-10">
                    ...
                    <form action="<?php echo current_url();?>" method="POST" class="form-horizontal">
                        <div class="form-group">
                            ...
                            <center><div class="col-md-4">
                                ...
                                <a href="<?=base_url()?>index.php/reporte/reporteVentaAnual" class="btn btn-round btn btn-warning"><i class="fa fa-refresh "></i></a>
                            </div>
                        </div>
                    </form>
                </div>
                ...
                <center><div class="col-md-2">
                    <?php echo form_open_multipart('reporte/reporteVentaAnualPDF'); ?>
